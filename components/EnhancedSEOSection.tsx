    ...
    <section className="py-20 cafe-section-bg relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div
          ...
          style={{ background: 'var(--cafe-gold)' }}
        ></div>
        <div
          className="absolute top-32 right-20 w-16 h-16 rounded-full"
          style={{ background: 'var(--cafe-copper)' }}
        ></div>
        <div
        ...
        ></div>
        <div
          className="absolute bottom-32 right-1/3 w-24 h-24 rounded-full"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <div
              className="w-32 h-1.5 mx-auto rounded-full mb-8"
              style={{ background: 'linear-gradient(90deg, var(--cafe-gold), var(--cafe-copper))' }}
            ></div>
            <p className="text-xl cafe-text-muted max-w-4xl mx-auto leading-relaxed">
              ร้าน <strong className="cafe-text-secondary">เสื้อผ้าแฟชั่นผู้หญิง</strong>{' '}
              สไตล์คาเฟ่มินิมอล ที่รวม{' '}
              <strong className="cafe-text-secondary">เสื้อผ้าไปคาเฟ่</strong> และ{' '}
              <strong className="cafe-text-secondary">เสื้อครอป</strong>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-8 animate-slide-in">
              <div className="cafe-card p-8 hover-lift cafe-animate-float">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold cafe-heading-primary">
                    ทำไมต้อง CafeWearTH?
                    <span className="cafe-text-secondary block text-lg mt-1">
                      เสื้อผ้าแฟชั่นสไตล์คาเฟ่ที่ใช่ที่สุด
                    </span>
                  </h3>
                </div>
                <div className="space-y-4 cafe-text-body leading-relaxed">
                  <p className="text-lg">
                    ...
                    <strong className="cafe-text-secondary"> เสื้อผ้าแฟชั่นผู้หญิง</strong>{' '}
                    ที่เชี่ยวชาญเรื่องลุคไปคาเฟ่! เรา
                    <strong className="cafe-text-secondary"> คัดสรรเสื้อผ้าไปคาเฟ่</strong>{' '}
                    ที่ทำให้คุณดูดีและถ่ายรูปสวยทุกมุม
                  </p>
                  <p>
                    พิเศษที่ <strong className="cafe-text-secondary">เสื้อครอปผู้หญิง</strong>{' '}
                    ทรงสวย เข้ารูป และ{' '}
                    <strong className="cafe-text-secondary">เสื้อครอปผู้ชาย</strong> unisex style
                    ที่คู่รักใส่คู่กันได้อย่างเก๋! ผลิตจากผ้าคุณภาพพรีเมียม ใส่สบาย ไม่ระคายผิว
                  </p>
                  <p>
                    คอลเลคชั่น<strong className="cafe-text-secondary"> เสื้อผ้าแฟชั่น</strong>
                    หลากสไตล์ จาก Vintage แนวคลาสสิค, Streetwear สุดเท่, Oversized ใส่สบาย
                    จนถึงสไตล์เกาหลีแท้ ด้วยราคาที่คุ้มค่าและจับต้องได้!
                  </p>
                  <div
                    className="mt-6 p-5 rounded-xl cafe-animate-glow relative overflow-hidden"
                    style={{
                      background:
                        'linear-gradient(135deg, var(--cafe-beige), var(--cafe-light-brown))',
                    }}
                  >
                    {/* Background Image */}
                ...
                {stats.map((stat, index) => (
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: `linear-gradient(135deg, var(--${stat.gradientFrom}), var(--${stat.gradientTo}))`,
                      }}
                    ></div>
                    <div className="relative z-10">
                      ...
                      <div className="text-xs cafe-text-muted">{stat.sublabel}</div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="cafe-card p-8 hover-lift">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold cafe-heading-primary">
                    คอลเลคชั่นสุดพิเศษ
                    <span className="cafe-text-secondary block text-base mt-1">
                      เสื้อผ้าแฟชั่นทุกสไตล์ที่คุณต้องการ
                    </span>
                  </h3>
                </div>
                    ...
                    >
                      ...
                      <div className="relative h-48 mb-4">
                        ...
                        <div
                          ...
                          style={{
                            background: `linear-gradient(135deg, var(--${service.gradientFrom})/80, var(--${service.gradientTo})/80)`,
                          }}
                        ></div>
                      ...
                      <div className="p-4">
                        ...
                        <p className="cafe-text-muted text-sm leading-relaxed">{service.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(135deg, var(--cafe-espresso) 0%, var(--cafe-mocha) 100%)',
                }}
              >
                {/* Background Image */}
                ...
                <div
                  ...
                  style={{ background: 'var(--cafe-gold)', opacity: 0.1 }}
                ></div>
                <div className="relative z-10">
                  <div className="flex items-center mb-6">
            ...
            <div className="space-y-8 animate-fade-in-up">
              ...
              <div className="cafe-card p-8 hover-lift">
                <div className="flex items-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold cafe-heading-primary">
                    ช้อปง่าย ได้ของเร็ว
                    <span className="cafe-text-secondary block text-base mt-1">
                      เพียง 4 ขั้นตอนสู่ลุคใหม่ที่สวยกว่าเดิม
                    </span>
                  </h3>
                </div>
                        ...
                        <div className="flex items-center mb-2">
                          <div
                            ...
                            style={{
                              ...
                              color:
                                item.textColor === 'text-white' ? 'white' : 'var(--cafe-espresso)',
                            }}
                          >
                            {item.step}
                          </div>
                          <h4 className="font-bold cafe-heading-secondary text-lg">{item.title}</h4>
                        </div>
                        <p className="cafe-text-muted leading-relaxed">{item.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(135deg, var(--cafe-coffee) 0%, var(--cafe-espresso) 100%)',
                }}
              >
                {/* Background Image */}
                <div className="absolute inset-0 opacity-10">
