      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-1">
            <Link
              href="/"
              className="px-4 py-2 cafe-text-secondary hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors font-medium"
            >
              หน้าแรก
            </Link>
            <Link
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="md:hidden p-2 sm:p-3 cafe-text-secondary hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors"
        ...
        {isMobileMenuOpen && (
          ...
          >
            <nav className="flex flex-col p-2">
              ...
              >
                <span className="w-8 h-8 bg-white rounded-full flex items-center justify-center mr-3 shadow-sm">
                  <FaTshirtAlt className="cafe-text-secondary w-4 h-4" />
                </span>
                สินค้าทั้งหมด
              </Link>
              <Link
              ...
              >
                <span className="w-8 h-8 bg-white rounded-full flex items-center justify-center mr-3 shadow-sm">
                  <FaInfoCircle className="cafe-text-secondary w-4 h-4" />
                </span>
                เกี่ยวกับเรา
              </Link>
              <Link
              ...
              >
                <span className="w-8 h-8 bg-white rounded-full flex items-center justify-center mr-3 shadow-sm">
                  <FaPhoneAlt className="cafe-text-secondary w-3.5 h-3.5" />
                </span>
                ติดต่อเรา
              </Link>
              <button
              ...
              >
                <span className="w-8 h-8 bg-white rounded-full flex items-center justify-center mr-3 shadow-sm">
                  <FaShoppingCart className="cafe-text-secondary w-4 h-4" />
                </span>
                ตะกร้าสินค้า
                {mounted && getCartItemCount() > 0 && (
                  <span
