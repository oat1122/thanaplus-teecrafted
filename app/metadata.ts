...
export const SITE_CONFIG = {
  ...
  description: "เสื้อแท้.com ร้านเสื้อผ้าแฟชั่นผู้หญิง เสื้อผ้าไปคาเฟ่ เสื้อครอปผู้หญิง-ผู้ชาย โทนเกาหลี คุณภาพดี ใส่ง่าย ถ่ายรูปสวย ราคาดี เหมาะทั้งสายสตรีท วินเทจ และโอเวอร์ไซส์",
  keywords: {
    primary: [
