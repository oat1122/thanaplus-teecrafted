...
export const SITE_CONFIG = {
  ...
  description:
    'เสื้อแท้.com ร้านเสื้อผ้าแฟชั่นผู้หญิง เสื้อไปคาเฟ่ เสื้อครอปผู้หญิง-ผู้ชาย โทนเกาหลี คุณภาพดี ใส่ง่าย ถ่ายรูปสวย ราคาสบายกระเป๋า',
  keywords: {
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'ช้อปเสื้อผ้าแฟชั่นผู้หญิง เสื้อไปคาเฟ่ เสื้อครอปผู้หญิง-ผู้ชาย สไตล์เกาหลี ราคาดี ใส่ง่าย ถ่ายรูปสวย ที่ CafeWearTH',
    url: SITE_CONFIG.url,
...
export const HOMEPAGE_CONTENT = {
  features: [
    ...
    {
      title: 'สไตล์หลากหลาย',
      description: 'มีทั้งเสื้อครอป เสื้อไปคาเฟ่ เสื้อแฟชั่นโอเวอร์ไซส์ และสตรีทแฟชั่น',
      icon: 'FaPalette',
    },
    {
      title: 'ส่งฟรีรวดเร็ว',
  ...
  benefits: [
    ...
    },
    {
      ...
      description: 'รับประกันคุณภาพเสื้อผ้าทุกชิ้น เปลี่ยน-คืนได้ มั่นใจในการสั่งซื้อ',
      icon: 'FaAward',
    },
    {
